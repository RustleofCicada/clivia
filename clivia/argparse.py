...
class _Arg:
    def __init__(self, names, dest, action, nargs, const, default, help, type): # CHANGE
        self.names = names
        self.dest = dest
        self.action = action
        self.nargs = nargs
...
class ArgumentParser:
    ...
    def add_argument(self, *args, **kwargs):
        ...
        list.append(
            _Arg(args, dest, action, kwargs.get("nargs", None),
                 const, default, kwargs.get("help", ""), kwargs.get("type", str)))  # CHANGE

    def usage(self, full, print=builtins.print):
        # print short usage
    ...
    def parse_args(self, args=None, print=builtins.print):
        return self._parse_args_impl(args, False, print=print)

    def parse_known_args(self, args=None, print=builtins.print):
        return self._parse_args_impl(args, True, print=print)

    def _parse_args_impl(self, args, return_unknown, print=builtins.print):
        if args is None:
            args = sys.argv[1:]
        else:
            args = args[:]
